                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group <?php echo e($errors->first('c_name') ? 'has-error' : ''); ?>">
                                ...
                                <input type="text" class="form-control" name="c_name"  placeholder="Tên ...">
                        ...
                        <div class="col-sm-12">
                            <div class="box-footer text-center">
                                ...
                                Hủy</a>
                                <button type="submit" class="btn btn-success">Thêm mới</i></button>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\banthoitrang\resources\views/admin/category/create.blade.php ENDPATH**/ ?>