...
<form role="form" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" name="a_name" placeholder="Giày cao gót ...." autocomplete="off" value="{{  $article->a_name ?? old('a_name') }}">
    ...
    <div class="col-sm-12 clearfix">
        <div class="box-footer text-center">
            ...
            <button type="submit" class="btn btn-success"> {{ isset($article) ? "Cập nhật" : "Thêm mới" }} </button> </div>
    </div>
</form>
