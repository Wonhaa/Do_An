    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li >
                    <a itemprop="url" href="<?php echo e(route('get.product.list')); ?>" title="Đồng hồ chính hãng"><span itemprop="title">Đồng hồ chính hãng</span></a>
                </li>
...
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\banthoitrang\resources\views/frontend/pages/product_detail/product_ratings.blade.php ENDPATH**/ ?>