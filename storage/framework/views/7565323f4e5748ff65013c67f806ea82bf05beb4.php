            ...
            <div class="login-box-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="email" class="form-control" name="email" placeholder="Email" value="doantotnghiep@gmail.com">
                        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="password" name="password" class="form-control" placeholder="Password" value="123456789">
...
<?php /**PATH D:\banthoitrang\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>