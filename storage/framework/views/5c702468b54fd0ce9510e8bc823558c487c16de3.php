                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group <?php echo e($errors->first('mn_name') ? 'has-error' : ''); ?>">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($menu->mn_name); ?>" name="mn_name"  placeholder="Tên ...">
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\banthoitrang\resources\views/admin/menu/update.blade.php ENDPATH**/ ?>