                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group <?php echo e($errors->first('c_name') ? 'has-error' : ''); ?>">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($category->c_name); ?>" name="c_name"  placeholder="Tên ...">
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel8-banthoitrangtest\resources\views/admin/category/update.blade.php ENDPATH**/ ?>