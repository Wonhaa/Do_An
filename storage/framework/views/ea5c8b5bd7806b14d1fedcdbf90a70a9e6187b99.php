    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li >
                    <a href="<?php echo e(route('get.blog.home')); ?>" title="Đồng hồ chính hãng"><span itemprop="title">Bài viết</span></a>
                </li>
                <li >
                    <a href="javascript://" title="Đồng hồ chính hãng"><span itemprop="title"><?php echo e($article->a_name); ?></span></a>
                </li>
            </ul>
        </div>
        <div class="blog-main">
...
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\banthoitrang\resources\views/frontend/pages/article_detail/index.blade.php ENDPATH**/ ?>