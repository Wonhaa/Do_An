<div id="popup-wallet" class="modal popup-wallet">
	...
	<form action="<?php echo e(route('post.recharge.process')); ?>" id="form-wallet" name="NLpayBank" method="POST">
		<?php echo csrf_field(); ?>
		<div class="content">
			...
			<div class="content-content">
				<div class="form-group">
					...
					<input type="text" name="money" id="money_online"  value="<?php echo e(str_replace(',','',\Cart::subtotal(0))); ?>" data-type="currency" placeholder="200,000" class="form-control" />
...
</div><?php /**PATH D:\banthoitrang\resources\views/components/popup/_inc_popup_wallet.blade.php ENDPATH**/ ?>