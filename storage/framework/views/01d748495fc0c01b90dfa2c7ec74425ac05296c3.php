    ...
    <section>
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="box">
                    <p>Hình thức:
                        <?php if($transaction->tst_type == 2): ?>
                        <b>Thanh toán qua ví</b>
                        <?php else: ?>
                        <b>Giao hàng nhận tiền</b>
                        <?php endif; ?>
                </p>
...
<?php echo $__env->make('layouts.app_master_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\banthoitrang\resources\views/user/order.blade.php ENDPATH**/ ?>